...
iOS (ios/Runner/Info.plist) içine eklenecekler:
    <key>NSMicrophoneUsageDescription</key>
    <string>Sesli sohbet odalarına katılabilmek için mikrofon izni gereklidir.</string>

### 2. Projeyi Çalıştırma

Gerekli Firebase yapılandırma dosyalarını ekledikten sonra terminalden şu komutları çalıştırarak projeyi başlatabilirsiniz:
...
Uygulamanın kod yapısı, kurulumu ve çalıştırılmasıyla ilgili anlatım videosunu aşağıdan izleyebilirsiniz:

▶️ Burak Zahter YouTube Kanalı - Uygulama Anlatım Videosu: https://www.youtube.com/@Burak.Zahter
